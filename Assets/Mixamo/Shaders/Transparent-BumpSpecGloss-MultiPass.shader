Shader "Mixamo/Transparent/Bump Spec Gloss MultiPass" {
Properties {
...
CGINCLUDE
  ...
  void surf (Input IN, inout SurfaceOutput o) {
    ...
    o.Specular = tex2D (_Specular, IN.uv_Specular).r * _SpecAmount;
    o.Gloss = tex2D (_Gloss, IN.uv_Gloss).r * _GlossAmount;
